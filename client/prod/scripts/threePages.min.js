...
j+=(g?"&":"?")+(l+"="+r),g=!0}}return j},r.prototype.is=function(a,b){return!0},r.prototype.encode=function(a,b){return a},r.prototype.decode=function(a,b){return a},r.prototype.equals=function(a,b){return a==b},r.prototype.$subPattern=function(){var a=this.pattern.toString();return a.substr(1,a.length-2)},r.prototype.pattern=/.*/,r.prototype.toString=function(){return"{Type:"+this.name+"}"},r.prototype.$normalize=function(a){return this.is(a)?a:this.decode(a)},r.prototype.$asArray=function(a,b){function d(a,b){function d(a,b){return function(){return a[b].apply(a,arguments)}}function e(a){return K(a)?a:G(a)?[a]:[]}function f(a){switch(a.length){case 0:return c;case 1:return"auto"===b?a[0]:a;default:return a}}function g(a){return!a}function h(a,b){return function(c){c=e(c);var d=n(c,a);return b===!0?0===m(d,g).length:f(d)}}function i(a){return function(b,c){var d=e(b),f=e(c);if(d.length!==f.length)return!1;for(var g=0;g<d.length;g++)if(!a(d[g],f[g]))return!1;return!0}}this.encode=h(d(a,"encode")),this.decode=h(d(a,"decode")),this.is=h(d(a,"is"),!0),this.equals=i(d(a,"equals")),this.pattern=a.pattern,this.$normalize=h(d(a,"$normalize")),this.name=a.name,this.$arrayMode=b}if(!a)return this;if("auto"===a&&!b)throw new Error("'auto' array mode is for query parameters only");return new d(this,a)},b.module("ui.router.util").provider("$urlMatcherFactory",s),b.module("ui.router.util").run(["$urlMatcherFactory",function(a){}]),t.$inject=["$locationProvider","$urlMatcherFactoryProvider"],b.module("ui.router.router").provider("$urlRouter",t),u.$inject=["$urlRouterProvider","$urlMatcherFactoryProvider"],b.module("ui.router.state").value("$stateParams",{}).provider("$state",u),v.$inject=[],b.module("ui.router.state").provider("$view",v),b.module("ui.router.state").provider("$uiViewScroll",w),x.$inject=["$state","$injector","$uiViewScroll","$interpolate"],y.$inject=["$compile","$controller","$state","$interpolate"],b.module("ui.router.state").directive("uiView",x),b.module("ui.router.state").directive("uiView",y),C.$inject=["$state","$timeout"],D.$inject=["$state","$stateParams","$interpolate"],b.module("ui.router.state").directive("uiSref",C).directive("uiSrefActive",D).directive("uiSrefActiveEq",D),E.$inject=["$state"],F.$inject=["$state"],b.module("ui.router.state").filter("isState",E).filter("includedByState",F)}(window,window.angular),function(){var a=angular.module("blog",["ui.router"]);a.config(function(a,b){b.otherwise("/"),a.state("signUp",{url:"/",controller:"createUserController",templateUrl:"../views/createUser.html"}).state("login",{url:"/",controller:"loginController",templateUrl:"../views/login.html"}).state("myProfile",{url:"/myProfile",controller:"myProfileController",templateUrl:"../views/myProfile.html"})})}(),function(){var a=function(a,b){a.signUp=function(c){b.post("/api/v1/user/signUp",{username:c.username,email:c.email,password:c.password}).success(function(b,c){a.status="User Created"}).error(function(b,c){a.status=b})}};a.$inject=["$scope","$http"],angular.module("blog").controller("createUserController",a)}(),function(){var a=function(a,b,c,d,e){a.loggedin=!1,window.fbAsyncInit=function(){FB.init({appId:"811000689006799",xfbml:!0,version:"v2.3"})},function(a,b,c){var d,e=a.getElementsByTagName(b)[0];a.getElementById(c)||(d=a.createElement(b),d.id=c,d.src="//connect.facebook.net/en_US/sdk.js",e.parentNode.insertBefore(d,e))}(document,"script","facebook-jssdk"),b.login=function(d){c.post("/api/v1/user/login",d).success(function(c,d){b.status=c,a.loggedin=!0;var f=JSON.stringify(c);localStorage.setItem("currentUser",f),e.go("myProfile")}).error(function(a,c){b.status=a})},b.logout=function(){c.post("api/v1/user/logout",token).success(function(b,c){console.log(b),a.loggedin=!1,localStorage.clear()}).error(function(a,c){console.log(a),b.status=a})},b.facebookLogin=function(){c.get("/auth/facebook").success(function(a){console.log(a)})}};a.$inject=["$rootScope","$scope","$http","$location","$state"],angular.module("blog").controller("loginController",a)}(),function(){var a=function(a,b,c,d){a.loggedin=!0,b.logout=function(){c.post("api/v1/user/logout",token).success(function(b,c){console.log("in the success function of logout"),a.loggedin=!1,localStorage.clear()}).error(function(a,c){console.log("in the error function of logout"),b.status=a})}};a.$inject=["$rootScope","$scope","$http","$location"],angular.module("blog").controller("logoutController",a)}(),function(){var a=function(a,b,c){var d=localStorage.getItem("currentUser"),e=JSON.parse(d);console.log(e.token),console.log(e.tokenCreatedTime),e.token&&e.tokenCreatedTime?b.post("api/v1/user/myProfile",{access_token:e.token}).success(function(a,b){console.log(a)}).error(function(a,b){console.log(a),c.path("/login")}):c.path("/login"),a.username=e.username};a.$inject=["$scope","$http","$location"],angular.module("blog").controller("myProfileController",a)}();